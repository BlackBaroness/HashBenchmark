 ...
 */
package ru.baronessdev.other.benchmark.hash.utils.encoding.base85;
...
public class Base85 {
    ...
    private static final int[] BASE85_POW = {1, 85, 85 * 85, 85 * 85 * 85, 85 * 85 * 85 * 85};
    ...
    public static String decode(String chars) {
        try {
            ...
            byte[] payload = chars.getBytes(StandardCharsets.UTF_8);
